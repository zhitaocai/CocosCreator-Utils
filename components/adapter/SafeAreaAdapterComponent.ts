...
export default class SafeAreaAdapterComponent extends cc.Component {
    ...
    public static get safeArea() {
        if (!this._safeArea) {
            ...
            //     let pixelRatio = IOSDeviceUtil.getDevicePixelRatio();
            //     screenWidth = IOSDeviceUtil.getScreenWidth() * pixelRatio;
            //     screenHeight = IOSDeviceUtil.getScreenHeight() * pixelRatio;

            //     safeAreaMarginTop = IOSDeviceUtil.getWindowSafeAreaTop() * pixelRatio;
            //     safeAreaMarginBottom = IOSDeviceUtil.getWindowSafeAreaBottom() * pixelRatio;
            //     safeAreaMarginLeft = IOSDeviceUtil.getWindowSafeAreaLeft() * pixelRatio;
            //     safeAreaMarginRight = IOSDeviceUtil.getWindowSafeAreaRight() * pixelRatio;
            // }
