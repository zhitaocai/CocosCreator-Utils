 ...
 * @since 2019-03-18
 */
export class ShowAllModeMultiResolutionAdapterUtil {
    ...
    static getScale(): number {
        return Math.min(cc.view.getCanvasSize().width / this.designResolutionWidth, cc.view.getCanvasSize().height / this.designResolutionHeight);
    }
